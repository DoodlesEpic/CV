...
\begin{itemize}
  ...
  \item Desenvolvo a interface desktop de visualização e operação do sistema em C++ (Qt 6, Qt Quick, CMake) e reescrevi em C++ moderno a pipeline de processamento dos logs, reduzindo o tempo de análise de cerca de 30 minutos para 20 segundos (aprox. 90x).
  \item Atuo também no Departamento Financeiro, apoiando rotinas administrativas e mantendo contato com o capitão, diretores de subsistemas e patrocinadores da equipe.
\end{itemize}
